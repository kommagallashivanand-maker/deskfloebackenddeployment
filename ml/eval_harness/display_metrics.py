...
print()
print("Note: priority_model v1.1.0 baseline (2026-07-24) requires en_core_web_sm.")
print("      CI and local setup must install the spaCy model (see requirements.txt).")
print()
